...
const downloadFromHost = async (options, host) => {
    ...
    const installedBrowser = await Util.install({
        ...
        downloadProgressCallback: (downloadedBytes, totalBytes) => {
            emitter.emit("onDownload", {downloadedBytes, totalBytes})
    ...
    emitter.emit("onDownloaded", installedBrowser.buildId)
...
const downloadStart = async (options, list) => {
    ...
    for (const item of list) {
        emitter.emit("onStartDownloading")
...
exports.eventsListener = emitter;
